    ...
    inquirer
      ...
      .then((answers) => {
        if (answers.vehicleType === 'Car') {
          ...
          this.createTruck(); // Call createTruck for truck selection
        } else if (answers.vehicleType === 'Motorbike') {
          this.createMotorbike(); // Call createMotorbike for motorbike selection
        }
      });
  }
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (selectedVehicle.vin === truck.vin) {
          // if it is, log that the truck cannot tow itself then allow the user to select another action
          console.log("A truck cannot tow itself.");
          this.performActions(); // Return to actions on the truck
        } else {
          // if it is not, tow the selected vehicle then allow the user to select another action
